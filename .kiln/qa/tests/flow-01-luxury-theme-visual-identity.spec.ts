...
test('FR-001: App loads with warm off-white background and charcoal text — no pure black or white', async ({
  page,
}) => {
  await page.goto('/')
...
test('FR-002: Body text, labels, and buttons use sans-serif typeface', async ({
  page,
}) => {
  await page.goto('/')
