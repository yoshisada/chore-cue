...
test.skip('US-002/FR-008: Chore board renders sections with thin borders, not colored backgrounds — requires credentials', async ({
  page,
}) => {
  // blocked:credentials
  await page.goto('/')
...
test.skip('US-002/FR-007: Overdue section label is uppercase with wide letter spacing and gold accent — requires credentials', async ({
  page,
}) => {
  // blocked:credentials
  await page.goto('/')
...
test.skip('US-002/FR-007: Due section label is uppercase with wide letter spacing — requires credentials', async ({
  page,
}) => {
  // blocked:credentials
  await page.goto('/')
...
test.skip('US-002/FR-007: Upcoming section label is uppercase with wide letter spacing — requires credentials', async ({
  page,
}) => {
  // blocked:credentials
  await page.goto('/')
...
test.skip('US-002/FR-016: Chore card has thin top border, generous padding, editorial hierarchy — requires credentials', async ({
  page,
}) => {
  // blocked:credentials
  await page.goto('/')
