...
test.skip('Phase1/FR-001: Create chore — happy path (every N days recurrence) — requires credentials', async ({
  page,
}) => {
  // blocked:credentials
  await page.goto('/')
...
test.skip('Phase1/FR-001: Create chore — weekly recurrence — requires credentials', async ({
  page,
}) => {
  // blocked:credentials
  await page.goto('/')
...
test.skip('Phase1/FR-010: Complete chore — completion recorded, next due recalculated — requires credentials', async ({
  page,
}) => {
  // blocked:credentials
  await page.goto('/')
...
test.skip('Phase1/FR-008: Chore list ordering — overdue before due before upcoming — requires credentials', async ({
  page,
}) => {
  // blocked:credentials
  await page.goto('/')
...
test.skip('Phase1/FR-011: Edit chore — changes persisted with luxury editorial styling — requires credentials', async ({
  page,
}) => {
  // blocked:credentials
  await page.goto('/')
...
test.skip('Phase1/FR-012: Archive chore — removed from board — requires credentials', async ({
  page,
}) => {
  // blocked:credentials
  await page.goto('/')
...
test.skip('Phase1/FR-015: Empty state uses serif typeface with generous spacing — requires credentials', async ({
  page,
}) => {
  // blocked:credentials
  await page.goto('/')
...
test.skip('edge-case: Long chore title truncates gracefully — requires credentials', async ({
  page,
}) => {
  // blocked:credentials
  await page.goto('/')
