...
test.skip('auth: Login flow — credentials + redirect to chore board — requires credentials', async ({ page }) => {
  // blocked:credentials
...
test.skip('auth: Signup flow — new account creation — requires credentials', async ({ page }) => {
  // blocked:credentials
...
test.skip('auth: Session persistence on reload — requires credentials', async ({ page }) => {
  // blocked:credentials
  await page.goto('/login');
  // Step 1: Log in
  // Step 2: Reload page
...
test('auth: Login page renders with luxury editorial styling (no credentials needed)', async ({ page }) => {
  await page.goto('/login');
...
test('auth: Signup page renders with luxury editorial styling (no credentials needed)', async ({ page }) => {
  await page.goto('/signup');
