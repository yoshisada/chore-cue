...
test.skip('Phase1/FR-013: Send polite bump — stays associated with chore and assignee — requires credentials', async ({
  page,
}) => {
  // blocked:credentials
  await page.goto('/')
...
test.skip('Phase1/FR-013: Bump daily limit — first 5 bumps accepted — requires credentials', async ({
  page,
}) => {
  // blocked:credentials
  await page.goto('/')
...
test.skip('Phase1/FR-014: Bump daily limit — 6th bump blocked — requires credentials', async ({
  page,
}) => {
  // blocked:credentials
  await page.goto('/')
